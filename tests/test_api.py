"""Tests for Home Assistant PyJU-Control api."""
import asyncio

import aiohttp
from custom_components.hass_pyjucontrol.api import (
    PyJuControlApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = PyJuControlApiClient("test", "test", async_get_clientsession(hass))
